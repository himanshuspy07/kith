 ...
 * Performs a deep reset of storage and cache to resolve root-level failures.
 */
    ...
    <html lang="en">
      <body className="antialiased bg-background text-foreground font-body overflow-hidden">
        <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center bg-background relative">
           ...
           <div className="relative z-10 flex flex-col items-center gap-8 animate-in-fade">
             ...
             <div className="space-y-4 max-w-md">
               ...
               <p className="text-muted-foreground font-medium leading-relaxed text-sm">
                 A root system error occurred. Resetting will wipe local workspace data and clear the browser cache.
               </p>
             </div>
