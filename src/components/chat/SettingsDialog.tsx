      ...
      <DialogContent className="sm:max-w-[750px] p-0 gap-0 border-none bg-card overflow-hidden rounded-[2rem] shadow-2xl h-[600px] flex flex-row">
        ...
        <aside className="w-1/3 bg-black/20 border-r border-white/5 p-6 flex flex-col">
          ...
          <div className="pt-6 border-t border-white/5 flex items-center gap-2.5 opacity-40 px-2">
            ...
            <span className="text-[9px] uppercase font-bold tracking-widest">Version 2.1.0</span>
          </div>
        </aside>
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="flex items-center gap-6 pb-6 border-b border-white/5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">This photo is public across kith.</p>
                  </div>
                </div>
                ...
                <div className="grid gap-6">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-black/10 border-white/5 h-12 rounded-xl focus-visible:ring-primary/40"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      className="bg-black/10 border-white/5 rounded-xl min-h-[100px] resize-none focus-visible:ring-primary/40 text-sm leading-relaxed"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-xs font-semibold text-muted-foreground">Profile Image Link</Label>
                    <Input 
                      value={avatarUrl} 
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="p-6 rounded-2xl bg-black/10 border border-white/5 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/5">
                    <div className="space-y-0.5">
                      <h4 className="font-bold text-sm">Status Indicator</h4>
                      <p className="text-xs text-muted-foreground">Show your online status to your connections.</p>
                    </div>
                    <div className="h-5 w-10 bg-primary/20 rounded-full relative">
                      <div className="absolute top-1 left-1 h-3 w-3 bg-primary rounded-full" />
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10 flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h4 className="font-bold text-sm">Always Connected</h4>
                    <p className="text-xs text-muted-foreground leading-normal">
                      Kith uses persistent connections to deliver messages instantly while the app is active.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-bold text-sm">Workspace Identity</h4>
                  </div>
                  <p className="text-xs text-muted-foreground bg-black/10 p-4 rounded-xl leading-relaxed border border-white/5">
                    Your unique device token is used to route secure notifications directly to this browser instance.
                  </p>
                  <Button 
                    variant="ghost" 
                  ...
                  >
                    <span className="text-xs font-medium text-muted-foreground uppercase tracking-widest">Device Token</span>
