          ...
          <CardContent className="px-10 pb-6">
            <div className="space-y-4">
              <Button 
                ...
                className="w-full h-14 rounded-2xl border-white/10 bg-white/5 hover:bg-white/10 text-foreground font-bold flex items-center justify-center gap-2 transition-all"
              >
                {isGoogleLoading ? (
